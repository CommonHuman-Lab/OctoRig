...
export const PRESETS: Record<string, Preset> = {
  default: {
    ...
    widgets: [
      ...
      panel("panel_active_deployments", 8, "md"),
      panel("panel_external_containers", 8, "md"),
    ],
  },
  competitor: {
    label: "Competitor",
    ...
    widgets: [
      ...
      panel("panel_scoreboard", 4, "md"),
      panel("panel_events", 4, "md"),
      panel("panel_challenges", 4, "md"),
      panel("panel_badges", 4, "md"),
    ],
  },
  minimal: {
    label: "Minimal",
  ...
  admin_overview: {
    ...
    widgets: [
      ...
      stat("stat_database"),
      panel("panel_active_deployments", 8, "md"),
      panel("panel_admin_activity", 4, "lg"),
      panel("panel_scheduled_actions", 4, "lg"),
    ],
  },
};
