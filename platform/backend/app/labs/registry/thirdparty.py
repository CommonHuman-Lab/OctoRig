...
THIRDPARTY_LABS: list[LabDefinition] = [  # type: ignore[assignment]
    {
        ...
        "access_info": [
            {"key": "URL", "value": "http://{container_ip}:3000"},
        ],
        "volume_names": [],
        "env_vars": {},
    ...
    },
    {
        ...
        "access_info": [
            {"key": "URL", "value": "http://{container_ip}"},
            {"key": "SSH", "value": "ssh msfadmin@{container_ip} (password: msfadmin)"},
        ],
        "volume_names": [],
        "env_vars": {},
    ...
    },
    {
        ...
        "access_info": [
            {"key": "URL", "value": "http://{container_ip}:8080/WebGoat"},
        ],
        "volume_names": [],
        "env_vars": {},
        "requires_privileged": False,
